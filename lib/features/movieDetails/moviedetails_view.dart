...
class MovieDetailsView extends MovieDetailsViewModel {
  // Future fillWatchlist(BuildContext context) async {
  //   List<Movie> watchlistMovies = [];
  //   watchlistMovies = await context.read<UserDbService>().getWatchList();
  //   for (int i = 0; i < watchlistMovies.length; i++) {
  //     context.read<User>().watchlist[watchlistMovies[i].movieId] = true;
  //   }
  // }
  //
  // Future fillWatched(BuildContext context) async {
  //   List<Movie> watchedMovies = [];
  //   watchedMovies = await context.read<UserDbService>().getWatchedList();
  //   for (int i = 0; i < watchedMovies.length; i++) {
  //     context.read<User>().watched[watchedMovies[i].movieId] = true;
  //   }
  // }
  //
  // Future fillFavorites(BuildContext context) async {
  //   List<Movie> favoritesMovies = [];
  //   favoritesMovies = await context.read<UserDbService>().getFavoriteList();
  //   for (int i = 0; i < favoritesMovies.length; i++) {
  //     context.read<User>().favorites[favoritesMovies[i].movieId] = true;
  //   }
  // }
